...
WAIT_TIME = 5
GOOGLE_LOG_FILE = 'C:\\Users\\Tezzz\\Documents\\Estudios\\Z -MSc Data Science\\999 - DISSERTATION\\google_log.txt'
...
def query_gemini(question: str, data_file: str = "") -> str:
    ...
    if data_file != "":
        ...
        response = model.generate_content(question + " " + table, stream=False)
    else:
